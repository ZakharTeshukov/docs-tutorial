  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        class: "focus:outline-none print:border-0 bg-white border border-[#C7C7C7] flex flex-col min-h-[1054px] w-[816px] pt-10 pr-14 pb-10 pl-14 cursor-text",
      },
    },
    extensions: [
      StarterKit,
      Image.configure({
        ...
        HTMLAttributes: {
          class: "custom-image image", // Add a custom class for styling
        },
      }),
      ImageResize,
      TaskItem.configure({
